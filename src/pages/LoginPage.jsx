      ...
      <div className="w-full max-w-md" style={{ backgroundColor: colors.surface, border: `1px solid ${colors.border}`, borderRadius: '20px', padding: '40px', boxShadow: '0 8px 40px rgba(30,58,95,0.10)' }}>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
          ...
          <button 
            ...
            style={{ backgroundColor: colors.primary, boxShadow: '0 4px 14px rgba(30,58,95,0.30)' }}
          >
        ...
        <button 
          ...
          style={{ backgroundColor: colors.surface, border: `1.5px solid ${colors.border}`, color: colors.textPrimary }}
        >
