-- db/migrations/002_rights_schema.sql
-- Rights Management schema for Hope PMS.
-- Run this after 001_initial_hopedb_schema.sql.
...
INSERT INTO user (userId, username, lastName, firstName, user_type, record_status, stamp) VALUES
...
CREATE TABLE module (
    Module_ID VARCHAR(30) NOT NULLPRIMARY KEY ,
